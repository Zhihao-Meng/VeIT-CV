...
def stereo_calibrate(mtx0, dist0, mtx1, dist1, frames_prefix_c0, frames_prefix_c1):
    ...
    for frame0, frame1 in zip(c0_images, c1_images):
        ...
        if c_ret1 == True and c_ret2 == True:
            ...
            corners1 = cv.cornerSubPix(gray1, corners1, (6, 6), (-1, -1), criteria)
            corners2 = cv.cornerSubPix(gray2, corners2, (6, 6), (-1, -1), criteria)
...
if __name__ == '__main__':
    ...
    check_calibration('camera0', camera0_data, 'camera1', camera1_data, _zshift=35.)
